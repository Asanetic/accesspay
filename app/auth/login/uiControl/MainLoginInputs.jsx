...
function MainLoginInputs({
  ...
  return (
    <div className="col-md-12 py-lg-5 mt-3 ">
      <div className="col-md-12 py-3 text-center">
        <img src={appLogo} alt="App Logo" style={{ height: '150px' }} />
      </div>

      <h4 className="col-md-12 mb-3 text-center">{appName}</h4>
      <p className="my-2 text-center">Login to proceed</p>
