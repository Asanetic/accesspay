...
export default function SettingsList({ dataIn = {}, dataOut = {} }) {
  ...
  // Compute auto_generate_request_numbers totals
  const sumsettings_auto_generate_request_numbers = stateItem.settingsListData?.reduce(
    (sum, row) => sum + Number(row.auto_generate_request_numbers || 0),
    0
  );
        ...
        {stateItem.settingsLoading ? (
          ...
          stateItem.settingsListData.map((listsettings_result, index) => {
              ...
              <Fragment key={`_row_${listsettings_result.primkey}`}>
                <tr key={listsettings_result.primkey}>
                  <td>
                    ...
                    <td scope="col"><span>{mosyTonum(listsettings_result.auto_generate_request_numbers)}</span></td>
            ...
            <tr className="bg-light">
              ...
              <th scope="col"><b></b></th>
              <th scope="col"><b></b></th>
              <th scope="col"><b><span>{mosyTonum(sumsettings_auto_generate_request_numbers)}</span></b></th>
