/**
 * Final FILE: approvals-automapper.jsx
...
// PURPOSE : Open Approval History modal
// ════════════════════════════════════════════════════════════════
    ...
    MosyCard(
        ...
        <div className="col-md-12 p-0" id="modal4">
            ...
            >
                ...
                <a
                    href={`../approvals/list?approvals_mosyfilter=${btoa(`${childCol}='${btoa(parentColVal)}'`)}`}
