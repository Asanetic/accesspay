...
// ════════════════════════════════════════════════════════════════
// Imports from pending-approvals.jsx
import {
  filterPendingApprovals
} from '../logicControl/pending-approvals';
              ...
              <Fragment key={`_row_${listapprovals_result.primkey}`}>
                <tr key={listapprovals_result.primkey}>
                  <td>
                    <div className="table_cell_dropdown">
                      <div className="table_cell_dropbtn">
                        ...
                        <div className="table_cell_dropdown-content">
                          ...
                          icon="list "
                          dataIn={() => viewRequests({childCol:`recordId`,parentColVal:listapprovals_result.request_id,parentName:listapprovals_result.approval_level})}   // only runs on click now
                          callBack={(incomingRequest) => {setChildDataOut(incomingRequest) }}
                          />
                          <MosyGridRowOptions
                          src="ApprovalsList"
                          ...
                          label=" Staff Details"
                          icon="list "
                          dataIn={() => viewStaff({childCol:`recordId`,parentColVal:listapprovals_result.staff_id,parentName:listapprovals_result.approval_level})}   // only runs on click now
                          callBack={(incomingRequest) => {setChildDataOut(incomingRequest) }}
                          />
                        </div>
                      </div>
                    ...
                    <td scope="col"><span title={listapprovals_result.request_id}>{magicTrimText(listapprovals_result._requests_request_number_request_id, 70)}</span></td>
                    <td scope="col"><span title={listapprovals_result.staff_id}>{magicTrimText(listapprovals_result._staff_full_name_staff_id, 70)}</span></td>
                    ...
                    <td scope="col"><span>
                      <ReactMarkdown>
                        ...
                        {magicTrimText(listapprovals_result.approval_comments, 70)}
                        
                      </ReactMarkdown>
                    </span></td>
                    <td scope="col"><span title={listapprovals_result.approved_on}>{mosyFormatDateTime(listapprovals_result.approved_on)}</span></td>
