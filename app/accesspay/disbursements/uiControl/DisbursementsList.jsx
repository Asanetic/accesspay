              ...
              <Fragment key={`_row_${listdisbursements_result.primkey}`}>
                <tr key={listdisbursements_result.primkey}>
                  <td>
                    <div className="table_cell_dropdown">
                      <div className="table_cell_dropbtn">
                        ...
                        <div className="table_cell_dropdown-content">
                          ...
                          icon="list "
                          dataIn={() => viewRequests({childCol:`recordId`,parentColVal:listdisbursements_result.request_id,parentName:listdisbursements_result.disbursement_number})}   // only runs on click now
                          callBack={(incomingRequest) => {setChildDataOut(incomingRequest) }}
                          />
                          <MosyGridRowOptions
                          src="DisbursementsList"
                          ...
                          label=" Staff Details"
                          icon="list "
                          dataIn={() => viewStaff({childCol:`recordId`,parentColVal:listdisbursements_result.staff_id,parentName:listdisbursements_result.disbursement_number})}   // only runs on click now
                          callBack={(incomingRequest) => {setChildDataOut(incomingRequest) }}
                          />
                        </div>
                      </div>
                    ...
                    <td scope="col"><span title={listdisbursements_result.request_id}>{magicTrimText(listdisbursements_result._requests_request_number_request_id, 70)}</span></td>
                    <td scope="col"><span title={listdisbursements_result.staff_id}>{magicTrimText(listdisbursements_result._staff_full_name_staff_id, 70)}</span></td>
                    ...
                    <td scope="col"><span title={listdisbursements_result.disbursement_notes}>{magicTrimText(listdisbursements_result.disbursement_notes, 70)}</span></td>
