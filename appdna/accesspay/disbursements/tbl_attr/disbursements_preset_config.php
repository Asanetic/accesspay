...
//"primkey" , "record_id" , "request_id" , "staff_id" , "disbursement_number" , "amount_disbursed" , "reference_number" , "payment_method" , "disbursement_notes" , "disbursed_by" , "disbursed_on" , "disbursement_status" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  // Core definitions
  // =========================
  $primary_table__="disbursements";
  $__page_title ="Disbursements";

  $core_module_configs_=[

    //important
    "primary_table"=>$primary_table__,
    "table_alias" =>"disbursements",     
    "primary_key"=>"primkey",
    "record_id"=>"record_id",
    "main_page_title"=>$__page_title,
    "api_endpoint_name"=>"disbursementslist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
        ...
        "desired_column_order" => [
            "disbursements" => ["primkey","record_id","request_id","staff_id","disbursement_number","amount_disbursed","reference_number","payment_method","disbursement_notes","disbursed_by","disbursed_on","disbursement_status","created_at","updated_at","hive_site_id","hive_site_name"]
        ],

        // Grouped inputs
        "form_input_segmentation_arr" => [
            "disbursements" => [
                "Basic Information" => ["primkey","record_id","request_id","staff_id","disbursement_number","amount_disbursed","reference_number","payment_method","disbursement_notes"]
            ]
        ],
        ...
        "skip_cols_list" => ["disbursed_by","disbursed_on","disbursement_status","created_at","updated_at","hive_site_id","hive_site_name"],
        ...
        "textarea_array" => ["disbursement_notes"],
        ...
        "new_label_buttons_arr" => [
            "disbursements" => "plus-circle:New Disbursements:{`Disbursements / \${disbursementsNode?.staff_id}`}"
        ],
    ...
    "import"=>[
        ...
        "disbursements"=>[
            ...
            "csv"=>"primkey,record_id,request_id,staff_id,disbursement_number,amount_disbursed,reference_number,payment_method,disbursement_notes,disbursed_by,disbursed_on,disbursement_status,created_at,updated_at,hive_site_id,hive_site_name",
