...
//"primkey" , "record_id" , "full_name" , "staff_number" , "phone_number" , "email_address" , "department" , "position" , "advance_limit" , "current_outstanding_balance" , "staff_status" , "registered_on" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
        ...
        "desired_column_order" => [
            "staff" => ["primkey","record_id","full_name","staff_number","phone_number","email_address","department","position","advance_limit","current_outstanding_balance","staff_status","registered_on","created_at","updated_at","hive_site_id","hive_site_name"]
        ],

        // Grouped inputs
        "form_input_segmentation_arr" => [
            "staff" => [
                "Basic Information" => ["primkey","record_id","full_name","staff_number","phone_number","email_address","department","position","advance_limit"]
            ]
        ],
        ...
        "skip_cols_list" => ["current_outstanding_balance","staff_status","registered_on","created_at","updated_at","hive_site_id","hive_site_name"],
		...
		"rename_cols_array" => ["record_id" => "Message Type"],
        ...
        "new_label_buttons_arr" => [
            "staff" => "plus-circle:New Staff:{`Staff / \${staffNode?.staff_number}`}"
        ],
    ...
    "import"=>[
        ...
        "staff"=>[
            ...
            "csv"=>"primkey,record_id,full_name,staff_number,phone_number,email_address,department,position,advance_limit,current_outstanding_balance,staff_status,registered_on,created_at,updated_at,hive_site_id,hive_site_name",
