...
////1. mosy_sql_roll_back

//"primkey" , "roll_bk_key" , "table_name" , "roll_type" , "where_str" , "roll_timestamp" , "value_entries" , "hive_site_id" , "hive_site_name" , <br><br>
...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  // Core definitions
  // =========================
  $primary_table__="mosy_sql_roll_back";
  $__page_title ="Mosy Sql Roll Back";

  $core_module_configs_=[

    //important
    "primary_table"=>$primary_table__,
    "table_alias" =>"mosysqlrollback",     
    "primary_key"=>"primkey",
    "record_id"=>"roll_bk_key",
    "main_page_title"=>$__page_title,
    "api_endpoint_name"=>"mosysqlrollbacklist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
        ...
        "desired_column_order" => [
            "mosy_sql_roll_back" => ["primkey","roll_bk_key","table_name","roll_type","where_str","roll_timestamp","value_entries","hive_site_id","hive_site_name"]
        ],

        // Grouped inputs
        "form_input_segmentation_arr" => [
            "mosy_sql_roll_back" => [
                "Basic Information" => ["primkey","roll_bk_key","table_name","roll_type","where_str","roll_timestamp","value_entries","hive_site_id","hive_site_name"]
            ]
        ],
        ...
        "print_tables" => ["mosy_sql_roll_back"],
        ...
        "datetime_columns" => ["roll_timestamp"],

		"rename_cols_array" => [],

        "rename_tables_array" => [
            "mosy_sql_roll_back" => "Mosy Sql Roll Back"
        ],

        "new_label_buttons_arr" => [
            "mosy_sql_roll_back" => "plus-circle:New Mosy Sql Roll Back:{`Mosy Sql Roll Back / \${mosy_sql_roll_backNode?.roll_type}`}"
        ],
    ...
    "import"=>[
        ...
        "mosy_sql_roll_back"=>[
            ...
            "csv"=>"primkey,roll_bk_key,table_name,roll_type,where_str,roll_timestamp,value_entries,hive_site_id,hive_site_name",
