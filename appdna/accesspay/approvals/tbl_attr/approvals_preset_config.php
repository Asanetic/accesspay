...
//"primkey" , "record_id" , "request_id" , "staff_id" , "approval_level" , "approved_by" , "approval_action" , "approval_comments" , "approved_on" , "approval_status" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  // Core definitions
  // =========================
  $primary_table__="approvals";
  $__page_title ="Approvals";

  $core_module_configs_=[

    //important
    "primary_table"=>$primary_table__,
    "table_alias" =>"approvals",     
    "primary_key"=>"primkey",
    "record_id"=>"record_id",
    "main_page_title"=>$__page_title,
    "api_endpoint_name"=>"approvalslist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
        ...
        "desired_column_order" => [
            "approvals" => ["primkey","record_id","request_id","staff_id","approval_level","approved_by","approval_action","approval_comments","approved_on","approval_status","created_at","updated_at","hive_site_id","hive_site_name"]
        ],

        // Grouped inputs
        "form_input_segmentation_arr" => [
            "approvals" => [
                "Basic Information" => ["primkey","record_id","request_id","staff_id","approval_level","approved_by","approval_action","approval_comments","approved_on"]
            ]
        ],
        ...
        "skip_cols_list" => ["approval_status","created_at","updated_at","hive_site_id","hive_site_name"],
		...
		"rename_cols_array" => ["request_id" => "Request Number","staff_id" => "Full Name"],
        ...
        "new_label_buttons_arr" => [
            "approvals" => "plus-circle:New Approvals:{`Approvals / \${approvalsNode?.staff_id}`}"
        ],
    ...
    "import"=>[
        ...
        "approvals"=>[
            ...
            "csv"=>"primkey,record_id,request_id,staff_id,approval_level,approved_by,approval_action,approval_comments,approved_on,approval_status,created_at,updated_at,hive_site_id,hive_site_name",
