...
//"primkey" , "record_id" , "request_id" , "staff_id" , "message_type" , "recipient" , "message_body" , "delivery_status" , "sent_on" , "message_status" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  // Core definitions
  // =========================
  $primary_table__="messages";
  $__page_title ="Messages";
  ...
  $core_module_configs_=[
    ...
    "api_endpoint_name"=>"messageslist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
        ...
        "desired_column_order" => [
            "messages" => ["primkey","record_id","request_id","staff_id","message_type","recipient","message_body","delivery_status","sent_on","message_status","created_at","updated_at","hive_site_id","hive_site_name"]
        ],

        // Grouped inputs
        "form_input_segmentation_arr" => [
            "messages" => [
                "Basic Information" => ["primkey","record_id","request_id","staff_id","message_type","recipient","message_body","delivery_status","sent_on"]
            ]
        ],
        ...
        "skip_cols_list" => ["message_status","created_at","updated_at","hive_site_id","hive_site_name"],
        ...
        "textarea_array" => ["message_type","message_body","message_status"],
        ...
        "new_label_buttons_arr" => [
            "messages" => "plus-circle:New Messages:{`Messages / \${messagesNode?.staff_id}`}"
        ],
    ...
    "import"=>[
        ...
        "messages"=>[
            ...
            "csv"=>"primkey,record_id,request_id,staff_id,message_type,recipient,message_body,delivery_status,sent_on,message_status,created_at,updated_at,hive_site_id,hive_site_name",
