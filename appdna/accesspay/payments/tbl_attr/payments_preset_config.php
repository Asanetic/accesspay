...
//"primkey" , "record_id" , "request_id" , "staff_id" , "payment_type" , "amount" , "reference_number" , "payment_method" , "payment_notes" , "recorded_by" , "recorded_on" , "payment_status" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  $core_module_configs_=[
    ...
    "api_endpoint_name"=>"paymentslist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
        ...
        "desired_column_order" => [
            "payments" => ["primkey","record_id","request_id","staff_id","payment_type","amount","reference_number","payment_method","payment_notes","recorded_by","recorded_on","payment_status","created_at","updated_at","hive_site_id","hive_site_name"]
        ],

        // Grouped inputs
        "form_input_segmentation_arr" => [
            "payments" => [
                "Basic Information" => ["primkey","record_id","request_id","staff_id","payment_type","amount","reference_number","payment_method","payment_notes"]
            ]
        ],
        ...
        "skip_cols_list" => ["recorded_by","recorded_on","payment_status","created_at","updated_at","hive_site_id","hive_site_name"],
        ...
        "new_label_buttons_arr" => [
            "payments" => "plus-circle:New Payments:{`Payments / \${paymentsNode?.staff_id}`}"
        ],
    ...
    "import"=>[
        ...
        "payments"=>[
            ...
            "csv"=>"primkey,record_id,request_id,staff_id,payment_type,amount,reference_number,payment_method,payment_notes,recorded_by,recorded_on,payment_status,created_at,updated_at,hive_site_id,hive_site_name",
