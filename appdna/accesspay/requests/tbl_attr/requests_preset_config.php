...
//"primkey" , "record_id" , "staff_id" , "request_number" , "amount_requested" , "request_reason" , "amount_approved" , "current_balance" , "requested_on" , "approved_on" , "paid_on" , "cleared_on" , "request_status" , "request_remarks" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  // Core definitions
  // =========================
  $primary_table__="requests";
  $__page_title ="Requests";
  ...
  $core_module_configs_=[
    ...
    "api_endpoint_name"=>"requestslist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
        ...
        "desired_column_order" => [
            "requests" => ["primkey","record_id","staff_id","request_number","amount_requested","request_reason","amount_approved","current_balance","requested_on","approved_on","paid_on","cleared_on","request_status","request_remarks","created_at","updated_at","hive_site_id","hive_site_name"]
        ],

        // Grouped inputs
        "form_input_segmentation_arr" => [
            "requests" => [
                "Basic Information" => ["primkey","record_id","staff_id","request_number","amount_requested","request_reason","amount_approved","current_balance","requested_on"]
            ]
        ],
        ...
        "skip_cols_list" => ["approved_on","paid_on","cleared_on","request_status","request_remarks","created_at","updated_at","hive_site_id","hive_site_name"],
        ...
        "textarea_array" => ["request_remarks"],
		...
		"rename_cols_array" => ["staff_id" => "Full Name","record_id" => "Message Type"],
        ...
        "new_label_buttons_arr" => [
            "requests" => "plus-circle:New Requests:{`Requests / \${requestsNode?.request_number}`}"
        ],
    ...
    "import"=>[
        ...
        "requests"=>[
            ...
            "csv"=>"primkey,record_id,staff_id,request_number,amount_requested,request_reason,amount_approved,current_balance,requested_on,approved_on,paid_on,cleared_on,request_status,request_remarks,created_at,updated_at,hive_site_id,hive_site_name",
