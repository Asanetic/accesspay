...
//"primkey" , "record_id" , "approval_levels" , "default_currency" , "sms_notifications" , "email_notifications" , "allow_partial_payments" , "allow_partial_recoveries" , "auto_generate_request_numbers" , "default_approval_workflow" , "system_status" , "setting_remarks" , "created_at" , "updated_at" , "hive_site_id" , "hive_site_name" , <br><br>
...
//A.I Notes  : max list col should be have 7 data important and relevant columns  , skip_cols_list the rest. eg if table have 20 cols  "skip_cols_list" => ["hive_site_id","hive_site_name", + the 13 cols ],  hive_site_id and hive_site_name should always be skipped in skip_cols_list skip_cols_profile
  ...
  include("../appdna/accesspay/global_app_ui_presets.php");
  ...
  // Core definitions
  // =========================
  $primary_table__="settings";
  $__page_title ="Settings";

  $core_module_configs_=[

    //important
    "primary_table"=>$primary_table__,
    "table_alias" =>"settings",     
    "primary_key"=>"primkey",
    "record_id"=>"record_id",
    "main_page_title"=>$__page_title,
    "api_endpoint_name"=>"settingslist",
  ...
  $novanest_module_ui_blueprint_ = [
    ...
    [
        ...
        "desired_column_order" => [
            "settings" => ["primkey","record_id","approval_levels","default_currency","sms_notifications","email_notifications","allow_partial_payments","allow_partial_recoveries","auto_generate_request_numbers","default_approval_workflow","system_status","setting_remarks","created_at","updated_at","hive_site_id","hive_site_name"]
        ],

        // Grouped inputs
        "form_input_segmentation_arr" => [
            "settings" => [
                "Basic Information" => ["primkey","record_id","approval_levels","default_currency","sms_notifications","email_notifications","allow_partial_payments","allow_partial_recoveries","auto_generate_request_numbers"]
            ]
        ],
        ...
        "skip_cols_list" => ["default_approval_workflow","system_status","setting_remarks","created_at","updated_at","hive_site_id","hive_site_name"],
        ...
        "textarea_array" => ["setting_remarks"],
        ...
        "new_label_buttons_arr" => [
            "settings" => "plus-circle:New Settings:{`Settings / \${settingsNode?.default_currency}`}"
        ],
    ...
    "import"=>[
        ...
        "settings"=>[
            ...
            "csv"=>"primkey,record_id,approval_levels,default_currency,sms_notifications,email_notifications,allow_partial_payments,allow_partial_recoveries,auto_generate_request_numbers,default_approval_workflow,system_status,setting_remarks,created_at,updated_at,hive_site_id,hive_site_name",
